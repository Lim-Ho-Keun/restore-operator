...
import (
	...
	fivegv1alpha1 "github.com/Lim-Ho-Keun/restore-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=fiveg.kt.com,resources=restores,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=fiveg.kt.com,resources=restores/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=fiveg.kt.com,resources=restores/finalizers,verbs=update
...
func (r *RestoreReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &fivegv1alpha1.Restore{}
	...
	var sshclient2 *simplessh.Client
